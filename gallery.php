...
<head>
    ...
    <title>Gallery - Shreyus Indian Supermarket</title>
        ...
        <div class="absolute top-0 left-0 w-full h-full bg-opacity-40 bg-black flex justify-center items-center">
                  <div class="max-w-[110rem] w-full mx-auto px-4 lg:px-6">
                    <div class="flex justify-center items-center ">
                      <h1 class="text-5xl text-white font-bold 2xl:mt-36 font-Protest">Our <span class="text-yellow-500">Gallery</span></h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mt-5">
            ...
            <div class="border bg-white p-2 rounded-xl">
                ...
                <div class="flex items-center justify-center">
                  <img loading="lazy" class="h-[250px] w-full object-cover rounded-xl border" src="./src/<?php echo $gallery['image']; ?>" />
                </div>
