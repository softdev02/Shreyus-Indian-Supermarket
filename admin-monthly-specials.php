        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mt-5">
            ...
            <div class="border bg-white p-5 rounded-xl">
                <div class="flex justify-end mb-2">
                    <button onclick="deleteeasonaldeals(<?php echo $gallery['id']; ?>)"><i class="fi fi-sr-trash text-red-500"></i></button>
                </div>
                <div class="flex items-center justify-center mb-3">
                  <img loading="lazy" class="h-full w-fit object-cover rounded-xl" src="./src/<?php echo $gallery['image']; ?>" />
                </div>
